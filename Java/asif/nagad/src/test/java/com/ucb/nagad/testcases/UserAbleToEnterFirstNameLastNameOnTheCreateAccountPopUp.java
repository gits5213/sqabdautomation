...
public class UserAbleToEnterFirstNameLastNameOnTheCreateAccountPopUp extends BaseClass {
    @Test
    public void userAbleToEnterFirstNameLastNameOnTheCreateAccountPopUp() {
